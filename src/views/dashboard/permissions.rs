...
use crate::data::models::graphql::acl::{
    ...
    FetchGrantedPermissionsResourcesResponse, FetchOrganizationsResponse, FetchPermissionsResponse,
    FetchSystemRolesResponse, RoleInput, RoleMetadata,
};
...
pub fn PermissionsList() -> impl IntoView {
    ...
    view! {
        <>
            ...
            <h1 class="mx-[20px]">Permissions</h1>
...
pub fn CreatePermission() -> impl IntoView {
    ...
    Effect::new(move || {
        spawn_local(async move {
            let fetch_resources_query = r#"
                   query FetchGrantedPermissionsResources {
                        fetchGrantedPermissionsResources {
                            name
                            id
                            createdBy
                        }
            ...
            let fetch_resources_response =
                perform_query_without_vars::<FetchGrantedPermissionsResourcesResponse>(
                    Some(&headers),
                    "http://localhost:8080/api/acl",
                ...
                Some(data) => {
                    resources.update(move |prev| {
                        let mut resources = data
                            .fetch_granted_permissions_resources
                            .as_ref()
                            .unwrap()
                            .iter()
                            .map(|resources| {
    ...
    view! {
        <>
            ...
            <h1 class="mx-[20px]">New Permission</h1>

            <h2 class="mx-[20px]">Permission Metadata</h2>
            ...
            <h2 class="mx-[20px]">Permission Info</h2>
