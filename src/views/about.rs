...
pub fn about() -> Html {
    ...
    let service_cards = use_state(|| vec![
        ServiceCardProps {
            ...
            description: "I develop robust, scalable and responsive Web Applications using technologies such as JavaScript, TypeScript, Node.js, NestJS, React, Angular, Yew(Rust) and Rocket(Rust). I am also an expert in Nginx Web server.".to_owned(),
        ...
        ServiceCardProps {
            ...
            description: "With the help of visualization tools such as D3.js and other chart libraries, I am able to help users gain insights into their data.".to_owned(),
        ...
        ServiceCardProps {
            ...
            description: "I can program embedded systems using Rust as a main language. I am also an IoT enthusiast.".to_owned(),
        ...
        <>
            ...
            <main class="about">
                ...
                <div class="details">
                    ...
                    <div class="autobio">
                        <h2>{ "Hello, I'm " } <span class="name">{current_state.first_name.clone() + " " + &current_state.middle_name.clone() + " " + &current_state.last_name.clone()}</span></h2>
