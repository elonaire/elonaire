...
pub fn WaitList() -> impl IntoView {
    ...
    view! {
        <div class="bg-navy flex flex-col gap-[40px] min-h-svh">
            <Nav onmenuclick=handle_menu_click() />
            <div class="text-contrast-white">
                // Top accent bar
                ...
                <div class="display-constraints">
                    ...
                    <div class="max-w-2xl mb-20">
                        ...
                        <h1 class="text-contrast-white mb-6">
                            "The Marketplace for"
                            <span class="text-primary"> " IoT builders,"</span>
                            " Leptos devs & curious minds."
                        </h1>
                        // Hero subtext
                        <p class="text-body text-mid-gray mb-10 max-w-xl">
                            "Edge-optimized backend services built around MQTT. Point them at your broker and they just work — no vendor lock-in, no cloud dependency. Plus Leptos templates, Ebooks, and courses for Rust developers who ship real products."
                        </p>

                        // Email form
                        <ReactiveForm form_ref=subscription_form_ref on:submit=handle_subscribe_form_submit>
                            <div class="flex flex-col sm:flex-row gap-3 max-w-md">
                                <InputField field_type=InputFieldType::Email placeholder="Enter your email" icon=IconId::BsEnvelope required=true id_attr="email" name="email" />
                                <BasicButton
                        ...
                        <p class="text-xs text-mid-gray mt-3">"No spam. Unsubscribe anytime."</p>
                    </div>
                    ...
                    <div class="mb-20">
                        <h6 class="text-mid-gray mb-10 text-contrast-white">"What's Coming?"</h6>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {[
                            ("ACL", "Fine-grained access control as a service. Roles, permissions, and resource guards — ready to plug into any stack.", "https://api.techietenka.com/files/view/be829ce6-1c68-4c88-8491-9e0df8817967?width=600"),
                            ("Storage", "Edge-optimized file storage with upload, retrieval, transformation and CDN delivery out of the box.", "https://api.techietenka.com/files/view/be829ce6-1c68-4c88-8491-9e0df8817967?width=600"),
                            ("Email", "Transactional and bulk email service with mailing lists, templates, and delivery analytics.", "https://api.techietenka.com/files/view/be829ce6-1c68-4c88-8491-9e0df8817967?width=600"),
                            ...
                            <div class="relative overflow-hidden h-[200px] rounded-[5px] border-[1px] border-gray">
                                <div
